package com.servicelight.nvstream;
...
import com.servicelight.nvstream.av.video.VideoDecoderRenderer;
import com.servicelight.nvstream.http.ComputerDetails;
import com.servicelight.nvstream.http.HostHttpResponseException;
...
public class NvConnection {
    // Context parameters
    private servicelightCryptoProvider cryptoProvider;
    ...
    public NvConnection(Context appContext, ComputerDetails.AddressTuple host, int httpsPort, String uniqueId, StreamConfiguration config, servicelightCryptoProvider cryptoProvider, X509Certificate serverCert)
    {
