package com.servicelight.nvstream.jni;
...
public class MoonBridge {
    /* See documentation in servicelight.h for information about these functions and constants */
    ...
    public static class AudioConfiguration {
        ...
        // See SURROUNDAUDIOINFO_FROM_AUDIO_CONFIGURATION() in servicelight.h
        ...
        // See MAKE_AUDIO_CONFIGURATION() in servicelight.h
        public int toInt() {
