...
import com.servicelight.BuildConfig;
import com.servicelight.LimeLog;
import com.servicelight.nvstream.ConnectionContext;
...
public class NvHTTP {
    ...
    private void initializeHttpState(final servicelightCryptoProvider cryptoProvider) {
        keyManager = new X509KeyManager() {
            public String chooseClientAlias(String[] keyTypes,
                    Principal[] issuers, Socket socket) { return "servicelight-RSA"; }
    ...
    public NvHTTP(ComputerDetails.AddressTuple address, int httpsPort, String uniqueId, X509Certificate serverCert, servicelightCryptoProvider cryptoProvider) throws IOException {
